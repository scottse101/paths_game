...
public class GoldAction implements Action {
   ...
   * @throws IllegalArgumentException if player is null or error while executing.
   */
  @Override
   ...
   * @throws IllegalArgumentException if player is null or error while reversing.
   */
  @Override
